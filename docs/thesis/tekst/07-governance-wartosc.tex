...
konsensusu, lecz z~przyrzeczenia tego dostawcy --- a~złośliwy dostawca może
...
niczego z~innymi obserwatorami. W~CT --- przeciwnie: pojedynczy obserwator
...
na~warstwie pierwszej, a~w~pełni --- po upływie okna sporu. Dla rozważanego tu
...
jest w~tej pracy wyceniona co do mikrocenta, strona PKI+CT --- wcale, ponieważ
jej koszt jest zdominowany przez pozycje spoza modelu transakcyjnego: opłatę za
certyfikat lub pieczęć kwalifikowaną dla każdej uczelni, utrzymanie usług
statusu (CRL/OCSP) oraz --- w~wariancie z~CT --- prowadzenie samego logu bądź
