...
import "../src/DiplomaRegistryA.sol";

contract DiplomaRegistryFGasTest is Test {
    DiplomaRegistryA reg;
    ...
    //     vm.prank(attacker);
    //     vm.expectRevert(DiplomaRegistryA.OnlyOwner.selector);
    //     reg.addIssuer(address(0xCAFE));
    // }
    ...
    //     vm.prank(attacker);
    //     vm.expectRevert(DiplomaRegistryA.OnlyIssuer.selector);
    //     reg.issue(docHash);
    // }
    ...
    //     vm.prank(issuer1);
    //     vm.expectRevert(DiplomaRegistryA.AlreadyIssued.selector);
    //     reg.issue(docHash);
    // }
    ...
    //     vm.prank(issuer1);
    //     vm.expectRevert(DiplomaRegistryA.AlreadyRevoked.selector);
    //     reg.revoke(docHash);
    // }
    ...
    //     vm.prank(issuer2);
    //     vm.expectRevert(DiplomaRegistryA.NotIssuerOfRecord.selector);
    //     reg.revoke(docHash);
    // }
