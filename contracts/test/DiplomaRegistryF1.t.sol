...
import "../src/DiplomaRegistryF.sol";

contract DiplomaRegistryFGasTest is Test {
    DiplomaRegistryF1 reg;
    ...
    function testGasRevert_addIssuer_onlyOwner() public {
        vm.prank(attacker);
        vm.expectRevert(DiplomaRegistryF1.OnlyOwner.selector);
        reg.addIssuer(address(0xCAFE));
    }
    ...
    function testGasRevert_issue_onlyIssuer() public {
        vm.prank(attacker);
        vm.expectRevert(DiplomaRegistryF1.OnlyIssuer.selector);
        reg.issue(docHash);
    }
    ...
    function testGasRevert_issue_alreadyIssued() public {
        ...
        vm.prank(issuer1);
        vm.expectRevert(DiplomaRegistryF1.AlreadyIssued.selector);
        reg.issue(docHash);
    }
    ...
    function testGasRevert_revoke_alreadyRevoked() public {
        ...
        vm.prank(issuer1);
        vm.expectRevert(DiplomaRegistryF1.AlreadyRevoked.selector);
        reg.revoke(docHash);
    }
    ...
    function testGasRevert_revoke_notIssuerOfRecord() public {
        ...
        vm.prank(issuer2);
        vm.expectRevert(DiplomaRegistryF1.NotIssuerOfRecord.selector);
        reg.revoke(docHash);
    }
